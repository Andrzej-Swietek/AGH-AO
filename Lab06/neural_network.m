...
% Do 26.01 Projekt
% - Kod - dowolny jezyk - precyzyjnie opisac jak uruchomić
% - Można wysłać link do githuba
% Dokumentacja : 
%     1. Co to jest co robi
%     2. Jak działa - jak dzialamy z konwolucyjnych sieci opisac
%     3. Jak uzywac - wczytac ustawic prog, co robi suwak
%     4. Co kto robił
%     5. Kazdy wie co kazdy element proejktu robi
%     6. Co nie działa + założenia kiedy cos dziala lepiej , format obrazka
%       czy cos, głupie błedy ktorych ciezko naprawic - opisane błedy nie sa odpirane negatywnie
%     7. Dane z kad sa i jakie sa i dla jakich danych na pewno cos dziala:
%     UCI Machine Learning archve/repository - otwarte baz danych
%     paperswithcode.com
%     8. GUI musi jakies byc - mozebyc webowe
